...
export const ButtonFavorite = ({ product }: ButtonFavoriteProps) => {
    ...
    return (
        <button className="cursor-pointer"><img src={product.favorite ? fillHeart : emptyHeart} data-favorite={product.favorite} alt="wishlist icon" onClick={handleFavorite} /></button>
    )
}
